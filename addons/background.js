...
// services
  ...
  async function serviceSaveAllTabToGithubGist() {
    let tabs = await browser.tabs.query({});
    let map = tabs.map(value => value.url)
  ...
  function initialCreateMenu() {
    browser.menus.create({
      ...
      onclick: async (info, tab) => {
        await serviceSaveAllTabToGithubGist()
        // todo end
      },
    }, null);
  }
